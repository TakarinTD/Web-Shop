...
public class ProductServiceImpl implements ProductService {
    ...
    @Override
    public Page<Product> findProductByKeyword(String keyword, int page, int pageSize, String sortField, String sortDir) {
        Pageable pageable = PageRequest.of(page - 1, pageSize,
                sortDir.equalsIgnoreCase("asc") ? Sort.by(sortField).ascending() : Sort.by(sortField).descending());
        return productRepository.findProductsByProductNameOrCategoryName(keyword, pageable);
    }
